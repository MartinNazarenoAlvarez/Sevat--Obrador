...
namespace ProyectoObrador.Datos
{
    ...
    {
        public string actualizarPrestamo(Asignacion _asignacion, Asignacion form, bool asignacionesInactivas)
        {
        ...
        public string eliminarPrestamo(int prestamoID)
        {
            ...
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("asp_eliminarPrestamo", SQLdatos);
                comando.CommandType = CommandType.StoredProcedure;
                comando.Parameters.AddWithValue("_prestamoID", prestamoID);
            ...
            {
                resultado = "Error al eliminar prestamo.";
                Funciones.Logs("Datos_EliminarPrestamo", $"Error: {ex.Message} - Detalle: {ex.ToString()}");
            }
            finally
            {
        ...
        public List<Prestamo> obtenerPrestamosEntreFechas(DateTime fechaInicio, DateTime fechaFin)
        {
            MySqlConnection SQLdatos = Conexion.GetConexion().crearConexion();
            MySqlDataReader resultado;
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand("psa_obtenerPrestamosEntreFechas", SQLdatos);
                comando.CommandType = CommandType.StoredProcedure;
            ...
            {
                Funciones.Logs("Datos_obtenerPrestamosEntreFechas", ex.ToString());
            }
            finally
            {
                if (SQLdatos.State == ConnectionState.Open)

...
namespace ProyectoObrador.Vistas
{
    public partial class Asignaciones : Form
    {
        ...
        private void cargarDatagird()
        {
            ...
            dvAsignacionesMostrar.BackgroundColor = Color.FromArgb(32, 32, 39);
            dvAsignacionesMostrar.DefaultCellStyle.BackColor = Color.FromArgb(11, 7, 17);
            dvAsignacionesMostrar.DefaultCellStyle.ForeColor = Color.LightGray;
            dvAsignacionesMostrar.DefaultCellStyle.SelectionBackColor = Color.DarkBlue;
            dvAsignacionesMostrar.DefaultCellStyle.SelectionForeColor = Color.White;
            dvAsignacionesMostrar.EnableHeadersVisualStyles = false; // deshabilita el estilo predeterminado de Windows
            dvAsignacionesMostrar.ColumnHeadersDefaultCellStyle.BackColor = Color.Navy;
            dvAsignacionesMostrar.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            dvAsignacionesMostrar.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 10F, FontStyle.Bold);
        }
